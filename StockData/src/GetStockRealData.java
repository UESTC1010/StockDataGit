...
//		 System.out.println(length);  
    	 ...
    	 for(int j=0;j<hisdata[0].length;j++){
        	if(j==3){ 
        		String zhengfu = df.format( 100*( Double.parseDouble(hisdata[0][6])-Double.parseDouble(hisdata[0][5]) )/( Double.parseDouble(hisdata[0][2])-Double.parseDouble(hisdata[0][3]) ));
        		hisdata[0][3] = zhengfu +"%";
        	}
